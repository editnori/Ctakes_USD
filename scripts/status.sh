...
echo "Writers       : Wrappers default to minimal CSV+timing; full set available via flags"
echo "Performance   : tmpfs staging + async CSV writer + progress logging (wrapper defaults)"
